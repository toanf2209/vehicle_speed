        ...
        if id in vh_down:
           ...
           if cy2<(cy+offset) and cy2 > (cy-offset):
             ...
             if counter.count(id)==0:
                ...
                if a_speed_kh > violate:
                   cropped_image = frame[y3:y4, x3:x4]
                   print('-------------------- > 10')
                   cv2.imwrite('save/'+randomString(15)+"__"+str(int(a_speed_kh))+'.jpg',cropped_image)
        ...
        if id in vh_up:
           ...
           if cy1<(cy+offset) and cy1 > (cy-offset):
             ...
             if counter1.count(id)==0:
                ...
                print(a_speed_kh1)
                if a_speed_kh1 > violate:
                   cropped_image = frame[y3:y4, x3:x4]
                   print('-------------------- > 10')
                   cv2.imwrite('save/'+randomString(15)+"__"+str(int(a_speed_kh1))+'.jpg',cropped_image)
